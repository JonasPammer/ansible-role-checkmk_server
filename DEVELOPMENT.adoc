...
When a new tag is pushed, https://github.com/JonasPammer/ansible-role-checkmk-server/actions/workflows/release-to-galaxy.yml[
a GitHub CI workflow] takes care of importing the role to my Ansible Galaxy Account.
image:https://github.com/JonasPammer/ansible-role-checkmk-server/actions/workflows/release-to-galaxy.yml/badge.svg[Release CI]
